...
export default function GeneratePassword() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-slate-600 dark:bg-gray-900">
      {/* Center the password generator card within the screen */}
      <Card className="w-full max-w-md p-6 bg-slate-300 [box-shadow:0px_0px_20px_black] shadow-lg rounded-lg">
